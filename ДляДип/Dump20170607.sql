...
INSERT INTO `questions` VALUES (1,1,'Сколько будет  2*3'),(2,1,'Сколько будет 2*4'),(3,1,'Сколько будет 3*7'),(4,1,'Сколько будет 2*2');
...
CREATE TABLE `test_info` (
  ...
  `Availble` tinyint(4) DEFAULT NULL,
  `Description` text,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-06-07 15:19:59
